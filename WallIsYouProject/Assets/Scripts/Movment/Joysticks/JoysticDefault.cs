...
namespace Assets.Scripts.Movment.Joysticks
{
    public abstract class JoysticDefault : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            ...
            if (RectTransformUtility.ScreenPointToLocalPointInRectangle(_joystickBackground.rectTransform, eventData.position, null, out backgroundAreaPosition))
            {
                _joystick.rectTransform.anchoredPosition = new Vector2(backgroundAreaPosition.x, backgroundAreaPosition.y);
            }
